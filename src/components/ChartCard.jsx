    ...
    <>
      <section className="flex w-auto flex-col ">
        <div className="flex md:flex-row flex-col gap-3">
          <div className="bg-base-300 flex-col relative mt-5 md:w-64 w-80 h-60 px-5 md:px-0 rounded-lg  flex items-center justify-center">
            <div className=" absolute  top-2 text-sm  px-2 rounded-xl text-eee-500 left-2">
              <p className=" fnt-medium text-base-800">User's card count</p>
            </div>
            <div className="mt-4">
          ...
          <div className="bg-base-300 relative mt-5 md:w-96 w-80 h-60 px-5 md:px-0 rounded-lg  flex items-center justify-center">
            <div className="mt-1 absolute top-1 text-sm px-2 rounded-xl text-eee-500 left-2">
              <p className="text-base-800">Users and Admin chart</p>
            </div>
