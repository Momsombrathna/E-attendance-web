            ...
            <div class="mt-6 relative">
              ...
              <div class="mt-1 rounded-md shadow-sm">
                <input
                  ...
                  className={`mt-1 bg-base-200 block w-full px-3 py-2 border text-base-800 border-base-200 rounded-md placeholder-gray-400 focus:outline-none focus:shadow-outline-blue focus:border-blue-300 transition duration-150 ease-in-out sm:text-sm sm:leading-5 ${
